...
const routes = [
  { from: "الرياض", lat: "24.71°N", lon: "46.68°E" },
  { from: "القاهرة", lat: "30.04°N", lon: "31.24°E" },
  { from: "دبي", lat: "25.20°N", lon: "55.27°E" },
  { from: "الخرطوم", lat: "15.60°N", lon: "32.55°E" },
];
  ...
  return (
    <>
      ...
      <main className="flex-1">
        ...
        {/* How it works */}
        <section id="how" className="border-b border-nino-line bg-nino-cream">
          <div className="mx-auto max-w-6xl px-6 py-20">
            <h2 className="font-display text-3xl md:text-4xl">
        ...
        {/* Footer CTA */}
        <section className="bg-nino-ink text-nino-white">
