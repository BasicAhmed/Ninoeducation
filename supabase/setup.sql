...
-- South African visa checkpoint feature: per-country embassy/VFS info
-- (admin-managed, verified — never populated with guessed data) and
-- per-student progress tracking through the checkpoint flow.
